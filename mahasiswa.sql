...
values (1,'20220001', 'Lisa', 'Perempuan', 'Surabaya', '2001-12-06', 'Jl. Wonosari Lor.72');
insert into mahasiswa (id_jurusan, nim, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, alamat)
values (1,'20220002', 'Haza', 'laki-laki', 'Jambi', '2000-03-13', 'Jl. Pahlawan.72');
